...
mnist.generate = get_generate("data2", "generate_cache.pkl", ["default", "shift"])
...
def training_process(model_path, total_epoch=1):
    ...
    for i in range(total_epoch):
        print("epoch", i)
        print("total training data", mnist.generate.num_examples)
...
if __name__ == '__main__':
    model_path = '/tmp/model_conv_bn_3.ckpt'
    output_path = '/tmp/sample_bn_3.csv'
    total_epoch=250
